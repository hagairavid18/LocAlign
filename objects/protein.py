...
class Protein:
    def __init__(self, pdb_name: str, ligand_name: str, model_idx: int = 0, chain_idx: int|None = 0) -> None:
    ...
    def get_model(self, model_idx: int) -> Model:
    ...
    def _get_atoms(self, id: str = " ") -> list[Atom]:
        ...
        for residue in list(self.get_model(self._model_idx))[self._chain_idx]:
            if residue.id[0] == id:
                atoms += list(residue)
